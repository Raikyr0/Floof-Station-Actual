...
/// Idenitical to Sericulture, exists because having both silkmaking and egglaying breaks stuff
/// </summary>
public abstract partial class SharedEgglayingSystem : EntitySystem
{
    // Managers
    ...
    /// </summary>
    private void OnMapInit(EntityUid uid, EgglayingComponent comp, MapInitEvent args)
    {
    ...
    /// </summary>
    private void OnCompRemove(EntityUid uid, EgglayingComponent comp, ComponentShutdown args)
    {
        _actionsSystem.RemoveAction(uid, comp.ActionEntity);
    }

    private void OnEgglayingStart(EntityUid uid, EgglayingComponent comp, EgglayingActionEvent args)
    {
        ...
        var doAfter = new DoAfterArgs(EntityManager, uid, comp.ProductionLength, new EgglayingDoAfterEvent(), uid)
    ...
    private void OnEgglayingDoAfter(EntityUid uid, EgglayingComponent comp, EgglayingDoAfterEvent args)
    {
...
/// </summary>
public sealed partial class EgglayingActionEvent : InstantActionEvent { }

/// <summary>
/// Is relayed at the end of the sericulturing doafter.
/// </summary>
[Serializable, NetSerializable]
public sealed partial class EgglayingDoAfterEvent : SimpleDoAfterEvent { }
