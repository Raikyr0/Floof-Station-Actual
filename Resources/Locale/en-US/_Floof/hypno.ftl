...
examined-hypno = {CAPITALIZE(POSS-ADJ($entity))} eyes seem dull and unfocused, gazing off into the distance, {POSS-ADJ($entity)} mind seems completely content with everything.
